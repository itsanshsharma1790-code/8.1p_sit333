...
public class RoutingServlet {
	...
	public RedirectView q1(
	    ...
	    Double calculatedResult =
	            MathQuestionService.q1Addition(number1, number2);

	    RedirectView redirectView = null;

	    if (calculatedResult == null || resultUser == null || resultUser.trim().isEmpty()) {
	        redirectView = new RedirectView("/q1", true);
	    ...
	    try {
	        ...
	        if (calculatedResult.equals(userAnswer)) {
	...
	public RedirectView q2(
	    ...
	    Double calculatedResult =
	            MathQuestionService.q2Subtraction(number1, number2);
	...
	public RedirectView q3(
	    ...
	    Double calculatedResult =
	            MathQuestionService.q3Multiplication(number1, number2);
